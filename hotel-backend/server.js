...
app.post("/cancel-booking", async (req, res) => {
  try {
    ...
    if (refund.error) {
      ...
      return res.status(500).json({ error: "Refund could not be processed. Please contact us on WhatsApp at +91 92864 48739." });
    }
    ...
    res.status(500).json({ error: "Something went wrong. Please contact us on WhatsApp at +91 92864 48739." });
  }
});
