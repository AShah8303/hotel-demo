    ...
    <div style="font-family:Arial,sans-serif;max-width:620px;margin:auto;border:1px solid #ddd;border-radius:8px;overflow:hidden;">
      ...
      <div style="padding:28px;">
        ...
        <div style="background:#2c3e2d;border-radius:6px;padding:16px 20px;color:#fff;">
          ...
          <p style="margin:3px 0;font-size:13px;">✉️ <span>hotelsudarshan.nainital</span><span>@</span><span>gmail.com</span></p>
          <p style="margin:8px 0 0;font-size:13px;">🕐 Check-in from 11:00 AM &nbsp;|&nbsp; Check-out by 10:00 AM</p>
        </div>
...
app.use((req, res, next) => {
  ...
  // The booking page may be served from a custom domain or a Vercel preview.
  // Reflect the requesting origin so browser booking requests are not blocked.
